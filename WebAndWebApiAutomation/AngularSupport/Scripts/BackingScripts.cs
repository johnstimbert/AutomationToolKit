...
namespace WebAndWebApiAutomation.AngularSupport.Scripts
{
    internal class BackingScripts
    {
        /** 
         ...
         * If false it tries a variety of methods to find an injector
...
";
         ...
         */
        internal const string WaitForAngular = GetNg1HooksHelper + @"
...
if (window.angular && !(window.angular.version && window.angular.version.major > 1)) {
    ...
    throw new Error('Cannot get testability API for unknown angular ' +
         ...
         */
        internal const string TestForAngular = @"
...
check();";
         ...
         */
        internal const string ResumeAngularBootstrap = @"
window.__TESTABILITY__NG1_APP_ROOT_INJECTOR__ = 
    angular.resumeBootstrap(arguments[0].length ? arguments[0].split(',') : []);";
         ...
         * arguments[0] {string} The selector housing an ng-app
         */
        internal const string GetLocation = GetNg1HooksHelper + @"
...
return hooks.$injector.get('$location').getLocation();";
         ...
         */
        internal const string SetLocation = GetNg1HooksHelper + @"
var hooks = getNg1Hooks(arguments[0]);
var url = arguments[1];
if (angular.getTestability) {
...
if (url !== $location.url()) {
    ...
    $rootScope.$digest();
         ...
         */
        internal const string Evaluate = @"
...
return angular.element(element).scope().$eval(expression);";
         ...
         */
        internal const string FindBindings = GetNg1HooksHelper + @"
...
return matches;";
         ...
         */
        internal const string FindModel = GetNg1HooksHelper + @"
...
for (var p = 0; p < prefixes.length; ++p) {
    ...
    if (inputs.length) {
         ...
         */
        internal const string FindSelectedOptions = @"
var model = arguments[0];
var using = arguments[2] || document;
var prefixes = ['ng-', 'ng_', 'data-ng-', 'x-ng-', 'ng\\:'];
for (var p = 0; p < prefixes.length; ++p) {
    ...
    if (inputs.length) {
         ...
         */
        internal const string FindAllRepeaterRows = @"
