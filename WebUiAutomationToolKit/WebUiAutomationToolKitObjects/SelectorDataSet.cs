...
namespace WebUiAutomationToolKit.WebAndApiAutomationObjects
{
    /// <summary>
    ...
    {        
        ...
        public void RemoveSelectorDataByName(string name)
        {
            ...
            if (toBeReomved == null)
                throw new WebUiAutomationException($"An item with the name {name} was not found");
        ...
        public void AddSelectorDataByName(SelectorData selectorDataToAdd)
        {
            ...
            if (dupe != null)
                throw new WebUiAutomationException($"The collection already contains a SelectorData object with the name {selectorDataToAdd.Name}");
